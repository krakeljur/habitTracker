...
import com.example.habittracker.databinding.AlertdialogAddRenameHabitBinding
...
import com.example.habittracker.view.adapters.HabitActionListener
import com.example.habittracker.view.adapters.HabitsAdapter
...
class HabitsFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this, MainViewModelFactory(Repositories, this))[HabitViewModel::class.java]
    }
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.uiHabitsState.collect { habitsUiState ->
                        hideAll()
                    if (habitsUiState.isError) {
                        showError()
                    } else if (habitsUiState.isLoading) {
                        showLoading()
                    } else if (habitsUiState.habits.isEmpty()) {
                        showEmpty()
