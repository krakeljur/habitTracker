...
import com.example.habittracker.databinding.AlertdialogRedactCommentCaseBinding
import com.example.habittracker.databinding.FragmentCasesBinding
import com.example.habittracker.databinding.PartLoadingBinding
import com.example.habittracker.model.Repositories
import com.example.habittracker.model.cases.Case
import com.example.habittracker.model.graph.Graph
import com.example.habittracker.model.timer.TimerCase
import com.example.habittracker.view.Consts.DAY_UNIX_MILLIS
import com.example.habittracker.view.Consts.KEY_HABIT_ID
import com.example.habittracker.view.adapters.CasesActionListener
import com.example.habittracker.view.adapters.CasesAdapter
import com.example.habittracker.view.adapters.ItemList
import com.example.habittracker.view.adapters.delegates.CaseDelegate
import com.example.habittracker.view.adapters.delegates.GraphDelegate
import com.example.habittracker.view.adapters.delegates.TimerDelegate
import com.example.habittracker.viewmodel.CasesViewModel
...
class CasesFragment : Fragment() {
    ...
    override fun onCreateView(
                ...
                viewModel.uiCasesState.collect { casesUiState ->
                    ...
                    if (casesUiState.isError) {
                        ...
                        for (case in casesUiState.cases.reversed()) {
                            ...
                            var date = Date(case.date - case.date % DAY_UNIX_MILLIS)
        ...
        loadingBinding.againButton.setOnClickListener { viewModel.updateCases() }
